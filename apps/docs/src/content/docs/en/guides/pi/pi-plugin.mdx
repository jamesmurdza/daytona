...
| ----------------- | ------------------------------ | ---------------------------------------------------------------------------------- |
| **Agent & tools** | The agent (LLM, TUI, sessions) | File operations and commands                                                       |
| **Git & GitHub**  | GitHub authorization with `gh` | Git operations (clone and push) via the [Daytona git API](/docs/en/git-operations) |
